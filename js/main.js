...
$App.wfs = localStorage.getItem("wfs");
$App.wfe = localStorage.getItem("wfe");
$App.wf4 = localStorage.getItem("wf4");
$App.wf5 = localStorage.getItem("wf5");
$App.wf6 = localStorage.getItem("wf6");
$App.wf7 = localStorage.getItem("wf7");
$App.wf8 = localStorage.getItem("wf8");
$App.wf9 = localStorage.getItem("wf9");
$App.wf10 = localStorage.getItem("wf10");
...
$scope.adhdhelperbut_click = function() {$App.OrderTidy2 = localStorage.getItem("OrderTidy2");
...
$scope.everytingelsebut_click = function() {$scope.AlertBoxEx("See own App","Max "+$App.eepc+"%","primary","","","",null );};
...
$App.h2001d = localStorage.getItem("h2001d");
$App.wfs = localStorage.getItem("wfs");
localStorage.setItem("wfe",$App.wfe);
$scope.GotoPage( "Wf" );};
$scope.Headline195_click = function() {$App.Ppom = localStorage.getItem("Fpom");
$App.Ppom1 = localStorage.getItem("Fpom1");
$App.Ppom2 = localStorage.getItem("Fpom2");
$App.Ppom3 = localStorage.getItem("Fpom3");
$App.Ppom4 = localStorage.getItem("Fpom4");
...
localStorage.setItem("Tot",$App.Tot);};
$scope.Headline197_click = function() {$App.Time = localStorage.getItem("Time");
$App.Time2 = localStorage.getItem("Time2");
$scope.GotoPage( "Timeline" );};
...
$scope.SetObjectStyle("healthbut","color","black");};
$scope.Headline132_click = function() {$App.thisapp = localStorage.getItem("thisapp");
$scope.GotoPage( "TodoThisApp" );};
$scope.Headline199_click = function() {$App.Ppom = localStorage.getItem("Fpom");
$App.Ppom1 = localStorage.getItem("Fpom1");
$App.Ppom2 = localStorage.getItem("Fpom2");
$App.Ppom3 = localStorage.getItem("Fpom3");
$App.Ppom4 = localStorage.getItem("Fpom4");
...
$App.wfe = localStorage.getItem("wfe");
$scope.GotoPage( "Wf" );};
$scope.Headline200_click = function() {$App.Ppom = localStorage.getItem("Fpom");
$App.Ppom1 = localStorage.getItem("Fpom1");
$App.Ppom2 = localStorage.getItem("Fpom2");
$App.Ppom3 = localStorage.getItem("Fpom3");
$App.Ppom4 = localStorage.getItem("Fpom4");
...
$App.wfe = localStorage.getItem("wfe");
$scope.GotoPage( "Wf" );};
$scope.Headline201_click = function() {$App.Ppom = localStorage.getItem("Fpom");
$App.Ppom1 = localStorage.getItem("Fpom1");
$App.Ppom2 = localStorage.getItem("Fpom2");
$App.Ppom3 = localStorage.getItem("Fpom3");
$App.Ppom4 = localStorage.getItem("Fpom4");
...
$App.wfe = localStorage.getItem("wfe");
$scope.GotoPage( "Wf" );};
$scope.Headline216_click = function() {$App.Planr = localStorage.getItem("Planr");
$App.Planra = localStorage.getItem("Planra");
$App.Planrb = localStorage.getItem("Planrb");
$App.Planrc = localStorage.getItem("Planrc");
$App.Planrd = localStorage.getItem("Planrd");
$App.Planre = localStorage.getItem("Planre");
$App.Planrf = localStorage.getItem("Planrf");
$scope.GotoPage( "PlanR" );};
$scope.Headline221_click = function() {$scope.GotoPage( "LBTEST" );};
});
...
$scope.TextInput3_change = function() {localStorage.setItem("wfs",$App.wfs);};
$scope.TextInput4_change = function() {localStorage.setItem("wfe",$App.wfe);};
$scope.TextArea46_change = function() {localStorage.setItem("wf3",$App.wf3);};
$scope.TextArea50_change = function() {localStorage.setItem("wf6",$App.wf6);};
$scope.TextArea76_change = function() {localStorage.setItem("wf5",$App.wf5);};
$scope.TextArea122_change = function() {localStorage.setItem("wf4",$App.wf4);};
$scope.TextArea123_change = function() {localStorage.setItem("wf7",$App.wf7);};
$scope.TextArea124_change = function() {localStorage.setItem("wf8",$App.wf8);};
$scope.TextArea125_change = function() {localStorage.setItem("wf9",$App.wf9);};
$scope.TextArea126_change = function() {localStorage.setItem("wf10",$App.wf10);};
});
...
NeoApp.controller("PlanR_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 6;
$App.NAB.PageID = "PlanR";
$scope.PushButton62_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea101_change = function() {localStorage.setItem("Planr",$App.Planr);};
$scope.TextArea103_change = function() {localStorage.setItem("Planra",$App.Planra);};
$scope.TextArea104_change = function() {localStorage.setItem("Planrb",$App.Planrb);};
$scope.TextArea105_change = function() {localStorage.setItem("Planrc",$App.Planrc);};
$scope.TextArea106_change = function() {localStorage.setItem("Planrd",$App.Planrd);};
$scope.TextArea107_change = function() {localStorage.setItem("Planre",$App.Planre);};
$scope.TextArea108_change = function() {localStorage.setItem("Planrf",$App.Planrf);};
$scope.PushButton67_click = function() {$App.Planra1 = localStorage.getItem("Planra1");
$scope.GotoPage( "PlanRa" );};
$scope.PushButton69_click = function() {$App.Planrb1 = localStorage.getItem("Planrb1");
$scope.GotoPage( "PlanRb" );};
$scope.PushButton70_click = function() {$App.Planrc1 = localStorage.getItem("Planrc1");
$scope.GotoPage( "PlanRc" );};
$scope.PushButton71_click = function() {$App.Planrd1 = localStorage.getItem("Planrd1");
$scope.GotoPage( "PlanRd" );};
$scope.PushButton72_click = function() {$App.Planre1 = localStorage.getItem("Planre1");
$scope.GotoPage( "PlanRe" );};
$scope.PushButton73_click = function() {$App.Planrf1 = localStorage.getItem("Planrf1");
$scope.GotoPage( "PlanRf" );};
});
NeoApp.controller("PlanRa_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 7;
$App.NAB.PageID = "PlanRa";
$scope.PushButton66_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea102_change = function() {localStorage.setItem("Planra1",$App.Planra1);};
$scope.PushButton74_click = function() {$scope.GotoPage( "PlanR" );};
});
NeoApp.controller("LBTEST_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 8;
$App.NAB.PageID = "LBTEST";
$scope.TimelineImage_click = function() {$scope.HideObject("TimelineImage","fadeOut",50);
$scope.ShowObject("timelinetext","fadeIn",50);};
$scope.timelinetext_click = function() {$scope.HideObject("timelinetext","fadeOut",50);
$scope.ShowObject("TimelineImage","fadeIn",50);};
$scope.PushButton91_click = function() {$scope.GotoPage( "Home" );};
$scope.Pager1_nextclick = function() {$scope.GotoNextPage();};
});
NeoApp.controller("LBTEST2_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 9;
$App.NAB.PageID = "LBTEST2";
$scope.ManText_click = function() {$scope.HideObject("ManText","fadeOut",50);
$scope.ShowObject("ManImage","fadeIn",50);};
$scope.PushButton92_click = function() {$scope.GotoPage( "Home" );};
$scope.Pager2_nextclick = function() {$scope.GotoPrevPage();};
});
NeoApp.controller("PlanRb_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 10;
$App.NAB.PageID = "PlanRb";
$scope.PushButton75_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea109_change = function() {localStorage.setItem("Planrb1",$App.Planrb1);};
$scope.PushButton76_click = function() {$scope.GotoPage( "PlanR" );};
});
NeoApp.controller("PlanRc_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 11;
$App.NAB.PageID = "PlanRc";
$scope.PushButton77_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea110_change = function() {localStorage.setItem("Planrc1",$App.Planrc1);};
$scope.PushButton78_click = function() {$scope.GotoPage( "PlanR" );};
});
NeoApp.controller("PlanRd_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 12;
$App.NAB.PageID = "PlanRd";
$scope.PushButton79_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea111_change = function() {localStorage.setItem("Planrd1",$App.Planrd1);};
$scope.PushButton80_click = function() {$scope.GotoPage( "PlanR" );};
});
NeoApp.controller("PlanRe_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 13;
$App.NAB.PageID = "PlanRe";
$scope.PushButton81_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea112_change = function() {localStorage.setItem("Planre1",$App.Planre1);};
$scope.PushButton82_click = function() {$scope.GotoPage( "PlanR" );};
});
NeoApp.controller("PlanRf_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 14;
$App.NAB.PageID = "PlanRf";
$scope.PushButton83_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea113_change = function() {localStorage.setItem("Planrf1",$App.Planrf1);};
$scope.PushButton84_click = function() {$scope.GotoPage( "PlanR" );};
});
...
$scope.TextArea100_change = function() {localStorage.setItem("Time2",$App.Time2);};
});
...
$App.Project002t = localStorage.getItem("Project002t");
$scope.GotoPage( "OrderTidy" );};
$scope.PushButton89_click = function() {localStorage.setItem("Project003t",$App.Project003t);
$App.Project003t = localStorage.getItem("Project003t");
$scope.GotoPage( "OrderTidy" );};
$scope.PushButton90_click = function() {localStorage.setItem("Project004t",$App.Project004t);
$App.Project004t = localStorage.getItem("Project004t");
$scope.GotoPage( "OrderTidy" );};
});
...
NeoApp.controller("TodoThisApp_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 22;
$App.NAB.PageID = "TodoThisApp";
$scope.PushButton40_click = function() {$scope.GotoPage( "Home" );};
$scope.Headline131_click = function() {$App.thisapp = localStorage.getItem("thisapp");
$scope.GotoPage( "TodoThisApp" );};
$scope.TextArea98_change = function() {localStorage.setItem("thisapp",$App.thisapp);};
});
...
$scope.PushButton85_click = function() {localStorage.setItem("Project003",$App.Project003);
localStorage.setItem("Project003a",$App.Project003a);
localStorage.setItem("Project003t",$App.Project003t);
localStorage.setItem("Project003b",$App.Project003b);
$scope.GotoPage( "Project003" );};
$scope.PushButton86_click = function() {localStorage.setItem("Project004",$App.Project004);
localStorage.setItem("Project004a",$App.Project004a);
localStorage.setItem("Project004t",$App.Project004t);
localStorage.setItem("Project004b",$App.Project004b);
$scope.GotoPage( "Project004" );};
});
...
NeoApp.controller("Project003_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 26;
$App.NAB.PageID = "Project003";
$scope.PushButton87_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea114_change = function() {localStorage.setItem("Project003",$App.Project003);};
$scope.TextArea115_change = function() {localStorage.setItem("Project003b",$App.Project003b);};
$scope.TextArea116_change = function() {localStorage.setItem("Project003a",$App.Project003a);};
});
NeoApp.controller("Project004_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 27;
$App.NAB.PageID = "Project004";
$scope.PushButton88_click = function() {$scope.GotoPage( "Home" );};
$scope.TextArea117_change = function() {localStorage.setItem("Project004",$App.Project004);};
$scope.TextArea118_change = function() {localStorage.setItem("Project004b",$App.Project004b);};
$scope.TextArea119_change = function() {localStorage.setItem("Project004a",$App.Project004a);};
});
