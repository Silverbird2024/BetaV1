...
$scope.Headline217_click = function() {localStorage.setItem("adhd",$App.adhd);
localStorage.setItem("ADHD2do",$App.ADHD2do);
localStorage.setItem("adhd1",$App.adhd1);
$scope.GotoPage( "Home" );};
$scope.PushButton41_click = function() {localStorage.setItem("adhd",$App.adhd);
localStorage.setItem("ADHD2do",$App.ADHD2do);
localStorage.setItem("adhd1",$App.adhd1);
$scope.GotoPage( "Home" );};
});
